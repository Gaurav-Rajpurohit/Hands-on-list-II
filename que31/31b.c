...
Description : b. Create a counting semaphore 
Date: Sept st, 2025.
============================================================================
*/
...
gaurav176@gaurav176-HP-Pavilion-Laptop-14-dv0xxx:~/Desktop/handsonlist2/que31$ ipcs -s -i 1
...
nsems = 1
otime = Not set                   
ctime = Sun Sep 21 15:54:34 2025  
